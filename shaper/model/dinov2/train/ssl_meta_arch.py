...
# pyre-fixme[21]: Could not find module `dinov2.layers`.
from dinov2.layers import DINOHead

# pyre-fixme[21]: Could not find module `dinov2.loss`.
from dinov2.loss import DINOLoss, iBOTPatchLoss, KoLeoLoss

# pyre-fixme[21]: Could not find module `dinov2.models`.
from dinov2.models import build_model_from_cfg

# pyre-fixme[21]: Could not find module `dinov2.models.vision_transformer`.
from dinov2.models.vision_transformer import BlockChunk

# pyre-fixme[21]: Could not find module `dinov2.utils.param_groups`.
