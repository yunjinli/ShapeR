...
class DepthEncoderDecoder(BaseDepther):
    ...
    def encode_decode(self, img, img_metas, rescale: bool = True, size=None):
    ...
    # pyre-fixme[14]: `simple_test` overrides method defined in `BaseDepther`
    #  inconsistently.
    def simple_test(self, img, img_meta, rescale: bool = True):
    ...
    # pyre-fixme[14]: `aug_test` overrides method defined in `BaseDepther`
    #  inconsistently.
    def aug_test(self, imgs, img_metas, rescale: bool = True):
