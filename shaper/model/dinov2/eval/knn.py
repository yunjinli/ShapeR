...
from dinov2.eval.utils import evaluate, extract_features, ModelWithNormalize
...
class KnnModule(torch.nn.Module):
    ...
    def __init__(
        self, train_features, train_labels, nb_knn, T, device, num_classes: int = 1000
    ) -> None:
        super().__init__()
...
def eval_knn_with_model(
    model,
    output_dir,
    train_dataset_str: str = "ImageNet:split=TRAIN",
    val_dataset_str: str = "ImageNet:split=VAL",
    nb_knn=(10, 20, 100, 200),
