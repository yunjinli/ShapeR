...
# pyre-fixme[21]: Could not find module `mmseg.core`.
...
# pyre-fixme[21]: Could not find module `mmseg.models.segmentors.base`.
...
# pyre-fixme[11]: Annotation `BaseSegmentor` is not defined as a type.
