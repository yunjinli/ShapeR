...
# pyre-fixme[21]: Could not find module `mmcv.cnn`.
from mmcv.cnn import build_activation_layer, build_norm_layer, Linear, xavier_init

# pyre-fixme[21]: Could not find module `mmcv.cnn.bricks.drop`.
from mmcv.cnn.bricks.drop import build_dropout

# pyre-fixme[21]: Could not find module `mmcv.cnn.bricks.registry`.
...
# pyre-fixme[21]: Could not find module `mmcv.cnn.bricks.transformer`.
...
# pyre-fixme[21]: Could not find module `mmcv.runner.base_module`.
from mmcv.runner.base_module import BaseModule, Sequential

# pyre-fixme[21]: Could not find module `mmcv.utils`.
...
try:
    # pyre-fixme[21]: Could not find module `mmcv.ops.multi_scale_deform_attn`.
...
# pyre-fixme[11]: Annotation `BaseTransformerLayer` is not defined as a type.
...
# pyre-fixme[11]: Annotation `TransformerLayerSequence` is not defined as a type.
