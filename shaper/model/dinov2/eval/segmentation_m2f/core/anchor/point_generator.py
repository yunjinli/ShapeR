...
class MlvlPointGenerator:
    ...
    def __init__(self, strides, offset: float = 0.5) -> None:
    ...
    def valid_flags(self, featmap_sizes, pad_shape, device: str = "cuda"):
    ...
    def single_level_valid_flags(self, featmap_size, valid_size, device: str = "cuda"):
